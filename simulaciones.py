def main():
    ...
    # 2 Cliente inválido (documento corto)
    try:
    ...
    # 4 Servicio con duración inválida
    try:
    ...
    # 6 Reserva con duración negativa
    try:
        r2 = Reserva(c1, s1, -1)
        r2.confirmar()
    except Exception as e:
    ...
    # 10 Error forzado (cliente y servicio None)
    try:
